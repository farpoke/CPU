...
\comment{Språk}{\CPU skall även inte hålla fördommar gentemot olika programmeringsspråk. Det är dock inget konstigt med att olika programmeringsspråk har olika antal supportrar.}
...
\emph{Medlemskap:} För att bli medlem i \CPU krävs att den potentiella medlemmen registrerat sig på \CPU[s] internetforum, deltagit i en CPU-aktivitet samt på lämpligt sätt uttryckt önskan att bli medlem.
...
\emph{Utgång ur CPU:} En medlem som ej deltagit i en aktivitet under pågående eller förehående år slutar vara en medlem i \CPU. En person som utgått på detta sätt har rätt att återigen bli en medlem på normalt sätt.
...
\comment{Styrelsemöte}{Föreslagsvis är ``rimlig tid'' åtminstone en dag eller två, men om så mycket tid ej behövs krävs inte detta av stadgarna. Underförstått är att alla styrelsemedlemmar skall ha en rimlig möjlighet att delta.}
...
Vid det ordinarie årsmötet ska väljas en revisor och vid behov en revisorsuppleant. Dessa får inte sitta i styrelsen.

Revisorn har under verksamhetsåret i uppgift att övervaka styrelsen och \CPU[s] verksamhet för att bedöma huruvida vid årsmöte tagna beslut har verkställts, samt att övervaka \CPU[s] eventuella ekonomiska aktiviteter.
...
\comment{Offentlighet}{Exempelvis via en direkt länk till dessa två dokument på \CPU[s] hemsida.}
...
Vid upplösning skall \CPU[s] eventuella tillgångar doneras till likasinnade fören\-ingar eller organisationer. Vilka föreningar eller organisationer detta är samt hur tillgångarna skall fördelas mellan dessa bestäms på mötet.
